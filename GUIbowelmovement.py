...
slide1 = tk.Scale(root, from_=0, to=50, resolution= 1, orient=tk.HORIZONTAL)
...
slide3 = tk.Scale(root, from_=0, to=300, resolution= 1, orient=tk.HORIZONTAL)
slide3.grid(row = 5, column = 1)
slide3.configure(background="mediumslateblue", foreground = "white")

#-------------------- Buttons ------------------

btn1 = tk.Button(root, text = "Submit", command = submit, height = 2, width = 10)
btn1.grid (row = 10, column = 1)
btn1.configure(background="mediumslateblue")
...
textboxRESULT = tk.Text(root, height = 10, width = 50, borderwidth = 3, relief = tk.GROOVE)
textboxRESULT.insert(tk.INSERT,"The Results Will Be Shown Here " + " \n")
textboxRESULT.config(state = "disabled")
textboxRESULT.grid(row = 11, column = 1)

textbox0 = tk.Text(root, height = 10, width = 40, borderwidth = 3, relief = tk.GROOVE)
textbox0.config(state = "disabled")
textbox0.grid(row = 11, column = 0)
#-------------------Program--------------------
